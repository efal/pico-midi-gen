            ...
            >
              <div
                className={`
                  ...
                  ${isActive
                    ? 'bg-primary-600/60 border-primary-400 backdrop-blur-md scale-110 shadow-[0_0_20px_rgba(168,85,247,0.5)]'
              ...
              {isEditing && !isPlaying && suggestions.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-2 z-10 glass-panel-heavy p-2 grid grid-cols-2 gap-2">
                  {suggestions.map(suggestion => (
                    <button
                      ...
                      className="bg-white/10 hover:bg-primary-500 hover:shadow-[0_0_10px_rgba(168,85,247,0.4)] text-white font-semibold py-2 px-1 rounded-md text-sm transition-all duration-150"
                    >
                      {suggestion}
                    </button>
                  ))}
